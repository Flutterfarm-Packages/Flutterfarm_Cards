...
class UnoHorizontalCard extends StatefulWidget {
  ...
  const UnoHorizontalCard({Key? key, this.CardColor,required this.CardText, this.CardTextStyle, required this.InitialImage, this.TextBackGroundColor, this.ImageBackGroundColor, this.gradientColor1, this.gradientColor2, required this.enableGradient}) : super(key: key);
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              height: 100,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.only(topLeft: Radius.circular(5),bottomLeft:Radius.circular(5),topRight:Radius.circular(72),bottomRight:Radius.circular(2),),
                  gradient:widget.enableGradient ? LinearGradient(
                      colors: [widget.gradientColor1,widget.gradientColor2]
                  ): null,
                color:widget.ImageBackGroundColor == null && widget.enableGradient == false ? Color(0xF1EDEDFF): widget.ImageBackGroundColor,
              ),

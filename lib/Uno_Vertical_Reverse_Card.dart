        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.only(topLeft: Radius.circular(12),bottomLeft:Radius.circular(15),topRight:Radius.circular(12),bottomRight:Radius.circular(15),),
                  image:widget.ImageBackGroundColor==null? DecorationImage(
                      image: AssetImage('assets/bubble.png',),fit: BoxFit.fill
                  ):null,
              color:widget.ImageBackGroundColor == null ? Color(0xFFFFFFFF): widget.ImageBackGroundColor,
              ),
            ...
            Container(
              ...
              child: Center(child: Text('${widget.CardText}',style:widget.CardTextStyle == null ?  TextStyle(fontWeight: FontWeight.w400, overflow: TextOverflow.ellipsis,color: Color(0xffffffff)): widget.CardTextStyle,textAlign: TextAlign.center,maxLines: 4,)),
            ),
          ],
        ),
      ),

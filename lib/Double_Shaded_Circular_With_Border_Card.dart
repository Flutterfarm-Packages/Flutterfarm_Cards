...
class DoubleShadedCircularWithBorderCard extends StatefulWidget {
  ...
  const DoubleShadedCircularWithBorderCard(
      {Key? key,
  ...
  @override
  _DoubleShadedCircularWithBorderCardState createState() =>
      _DoubleShadedCircularWithBorderCardState();
}

class _DoubleShadedCircularWithBorderCardState
    extends State<DoubleShadedCircularWithBorderCard> {
  @override

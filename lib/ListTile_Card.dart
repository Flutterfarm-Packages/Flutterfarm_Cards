        ...
        child: Center(
          child: Material(
            ...
            child: ListTile(
              ...
              tileColor:
                  widget.CardColor == null ? Colors.white : widget.CardColor,
              leading: widget.InitialImage,
              contentPadding: EdgeInsets.symmetric(horizontal: 19, vertical: 8),
              title: Text(
                '${widget.CardTitle}',
                style: widget.CardTitleTextStyle == null
                    ? TextStyle(
                        fontWeight: FontWeight.w600,
                        fontSize: 15,
                        overflow: TextOverflow.ellipsis)
                    : widget.CardTitleTextStyle,
                maxLines: 4,
              ),
              subtitle: Text(
                '${widget.CardSubTitle}',
                style: widget.CardSubTitleTextStyle == null
                    ? TextStyle(
                        fontWeight: FontWeight.w600,
                        overflow: TextOverflow.ellipsis)
                    : widget.CardSubTitleTextStyle,
              ),

...
class CurvedOneSidedCornerCard extends StatefulWidget {
  ...
  const CurvedOneSidedCornerCard({Key? key, this.CardColor,required this.CardText, this.CardTextStyle, required this.InitialImage, required this.enableGradient, this.gradientColor1, this.gradientColor2,}) : super(key: key);

  @override
  _CurvedOneSidedCornerCardState createState() => _CurvedOneSidedCornerCardState();
}
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.only(topLeft: Radius.circular(5),bottomLeft: Radius.circular(40),topRight: Radius.circular(5),bottomRight: Radius.circular(5),),

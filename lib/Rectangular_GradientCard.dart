...
class RectangularGradientCard extends StatefulWidget {
  ...
  const RectangularGradientCard({Key? key,  required this.CardTitle, this.CardTitleStyle, required this.InitialImage, this.gradientColor1, this.gradientColor2,  this.CardSubTitle, this.CardSubTitleStyle, this.CardWidth, this.CardHeight}) : super(key: key);

  @override
  _RectangularGradientCardState createState() => _RectangularGradientCardState();
}

...
class DoubleShadedCircularCard extends StatefulWidget {
  ...
  const DoubleShadedCircularCard({Key? key, required this.CardText, this.CardTextStyle, required this.InitialImage, this.InnerColor, this.OuterColor}) : super(key: key);

  @override
  _DoubleShadedCircularCardState createState() => _DoubleShadedCircularCardState();
}

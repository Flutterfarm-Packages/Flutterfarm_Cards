...
class SingleShadedCircularHorizontalCard extends StatefulWidget {
  ...
  const SingleShadedCircularHorizontalCard({Key? key, required this.CardText, this.ImageBackgroundColor,this.CardTextStyle, required this.InitialImage, }) : super(key: key);

  @override
  _SingleShadedCircularHorizontalCardState createState() => _SingleShadedCircularHorizontalCardState();
}

class _SingleShadedCircularHorizontalCardState extends State<SingleShadedCircularHorizontalCard> {
  @override

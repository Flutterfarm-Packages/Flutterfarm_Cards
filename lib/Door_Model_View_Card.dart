...
class DoorModelViewCard extends StatefulWidget {
  ...
  const DoorModelViewCard({Key? key, required this.CardText, this.CardTextStyle, required this.InitialImage, this.ImageBackGroundColor, this.TextBackGroundColor}) : super(key: key);
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Color(0xFF817DAF)
                ),
                child:Center(child: widget.InitialImage,)
              ),
              SizedBox(height: 10,),
              Center(
                child: Text('Fashion ',style: widget.CardTextStyle == null ? TextStyle(color: Colors.white) : widget.CardTextStyle,),
              )
            ],
          ),
        )
